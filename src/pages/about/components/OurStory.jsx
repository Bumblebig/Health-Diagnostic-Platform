    ...
    <section className="story row-2">
      <div className="text">
        ...
        <p className="description">
          ...
          quidem! Pariatur quia assumenda itaque illum consequatur blanditiis
          aliquam ipsa fugiat excepturi suscipit? Fugiat alias commodi fuga et
          eum tempore odit. Lorem ipsum dolor sit amet consectetur adipisicing

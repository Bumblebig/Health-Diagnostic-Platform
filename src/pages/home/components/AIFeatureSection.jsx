...
export default function AIFeatureSection() {
    return (
        <section className="bg-secondary py-14 px-4 text-white lg:px-12">
            ...
            <div className="mt-20 lg:flex lg:w-full lg:justify-between lg:items-center lg:mt-10 lg:px-5">
                <article className="flex flex-col gap-10 md:gap-14 lg:w-1/2">
                    <div className="flex flex-col gap-10 text-center md:flex-row md:items-start md:text-left md:justify-between">
                        <Benefits

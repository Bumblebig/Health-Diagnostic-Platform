...
export default function Hero() {
    return (
        <section className="bg-primary pt-20 text-white transition-all md:pt-20 lg:flex lg:items-center lg:pb-20 lg:gap-7 lg:pt-15 xl:pt-12 xl:gap-0 xl:pb-16">
            <div className="px-4 pt-7 xl:pl-9">
                ...
                <p className="mt-5 max-w-sm leading-7 pr-6 text-gray-300 lg:mt-6 lg:text-lg lg:max-w-xl">Introducing the Health Diagnostic Device, your personal health monitoring companion</p>
